...
class _AssistantPageState extends State<AssistantPage> {
  ...
  String _parseTimeframe(String text) {
    ...
    if (t.contains('today') || t.contains('this day') || t.contains('today\'s'))
      return 'Daily';
    ...
    if (t.contains('all time') || t.contains('overall') || t.contains('total'))
      return 'All';
  ...
  String _predictNextMonth() {
    ...
    if (monthList.isEmpty) {
      ...
      return 'No specific monthly data available. Estimated based on all recorded expenses: ₹${(_sum(widget.expenses) / (widget.expenses.length > 0 ? widget.expenses.length : 1)).toStringAsFixed(2)} per expense (rough estimate).';
    }
